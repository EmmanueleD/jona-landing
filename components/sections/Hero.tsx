...
const Hero = ({ data, whatsappNumber }: HeroProps) => {
  ...
  const handleWhatsAppClick = () => {
    ...
    const message = encodeURIComponent(
      "Hola, me gustaría consultar sobre tus servicios de Quiropraxia."
    );
    window.open(
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div
          ...
          style={{
            backgroundColor: "var(--heroBackgroundColor, rgba(0, 0, 0, 0.4))"
          }}
        ></div>
      </div>
      ...
      >
        <div
          className="max-w-2xl"
          style={{ color: "var(--heroTextColor, white)" }}
        >
          <h1
          ...
          {data.subtitle && (
            <p
              className="mb-8"
              style={{ fontSize: "var(--heroSubtitleSize, 1.5rem)" }}
            >
              {data.subtitle}
            </p>
          )}
